...
export default function Subscribe() {
  return (
    <section className="bg-getsparklin-main-black w-screen">
      <section className=" p-4 py-16 lg:p-16 relative h-[60vh] lg:h-[70vh] w-full lg:max-w-7xl mx-auto">
        <div>
          <h4 className="text-white text-5xl lg:text-6xl my-4 font-gilroy-medium">
