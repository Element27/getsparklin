...
const FeaturesComponent = ({
  ...
  return (
    ...
    // >
    <div
      className={`w-10/12 lg:w-full mx-auto mb-8 flex flex-col items-center justify-between px-4 gap-x-8 gap-y-4  ${
        reverse === true ? "lg:flex-row-reverse" : "lg:flex-row"
      }`}
    >
      <div className="w-full lg:w-1/2">
        <h2 className="text-2xl md:text-3xl lg:text-4xl py-2 font-gilroy-medium ">
          {title}
        </h2>
