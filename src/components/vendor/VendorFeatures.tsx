...
export default function VendorFeatures() {
  return (
    <section className="w-screen bg-white">
      <section className="py-8 mb-10 font-gilroy-medium w-full lg:max-w-7xl mx-auto">
        <div className="items-center py-[2%]">
          ...
          <span className="text-getsparklin-purple"> breeze</span>{" "} */}
            Here's how we{" "}
            <span className="text-getsparklin-purple">empower</span> your{" "}
            <br className="lg:block hidden" /> laundry business to soar
          </h3>
        </div>
        ...
        <div>
          ...
          <FeaturesComponent
            ...
            description={
              <span>
                Ditch fixed fees and enjoy a flexible subscription model based
                on actual usage.
                <br className="lg:block hidden" /> Perfect for growing
                businesses, it scales with your success.
              </span>
            }
            reverse={true}
          />
          <FeaturesComponent
            ...
            description={
              <span>
                Track supplies, automate reorders, and maintain optimal
                inventory levels with <br className="lg:block hidden" />
                our inventory & stock management tools. Never run out of
                detergent again!
              </span>
            }
            reverse={false}
